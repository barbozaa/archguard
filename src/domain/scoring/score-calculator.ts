import { Violation, HealthStatus, ScoreBreakdown } from '@domain/types.js';
...
export class ScoreCalculator {
  ...
  calculate(
    ...
    if (totalLOC && totalLOC > 0) {
      ...
      // Overall score: 80% architecture health + 20% code hygiene
      const score = Math.round(architectureScore * 0.8 + hygieneScore * 0.2);
